...
def parse_args():
    p = argparse.ArgumentParser(description="DDP training of SD1.4 UNet with LoRA adapters")
...
def main():
    ...
    vae.eval()
    base_unet = UNet2DConditionModel.from_pretrained("ckpt/epoch_16")
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        iterator = tqdm(loader, desc=f"Epoch {epoch}/{args.epochs}") if rank == 0 else loader
